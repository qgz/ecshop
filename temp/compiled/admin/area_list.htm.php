...
<!--h1><span class="action-span"><a href="area_manage.php?act=add&parent_id=<?php echo $this->_var['parent_id']; ?>">添加地区</a></span></h1-->
<!-- start category list -->
<div class="list-div">
...
?>
      ...
      <td class="first-cell" align="left">
       ...
       <?php endif; ?>
	   <a href="area_manage.php?act=edit_area&id=<?php echo $this->_var['list']['region_id']; ?>">编缉</a>&nbsp;&nbsp;
