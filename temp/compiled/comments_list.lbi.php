    ...
    <table class="pj_tb">
      <tbody>
        <tr>
          ...
          <td class="td3" align="center"><img src="/themes/meilele/images/pj.jpg" id="comment_goods_img" width="148" height="148" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" />
...
?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>.gif"></a></div>
          ...
          <td class="td2"><div class="arrow"></div>
			...
			<a href="xspace_show.php?id=<?php echo $this->_var['comment']['art_id']; ?>" target="_blank" class="red vb">查看秀家大图&gt;&gt;</a>
			</div>
		...
		function get_comment_img(){
			$('.img_area').each(
				function(i){
					...
					var temp = '<a href="xspace_show.php?id='+art_id+'" target="_blank"><img src="'+src+'" height="96"></a>&nbsp;';
