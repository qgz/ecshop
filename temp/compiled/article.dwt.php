...
<div class="w mt10 clearfix">
  <div class="sub_main clearfix">
    ...
    <div class="art_relative">
	  ...
	  <?php $_from = get_cat_arts_12(0); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_44396200_1443532512');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_44396200_1443532512']):
        $this->_foreach['artciles_list']['iteration']++;
?>
        <li><i>&bull;</i><span><a href="<?php echo $this->_var['article_0_44396200_1443532512']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['article_0_44396200_1443532512']['title']); ?>"><?php echo $this->_var['article_0_44396200_1443532512']['short_title']; ?></a></span></li>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </ul>
    </div>
...
?>
  ...
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	
    <div class="sideMod">
	  ...
	  <?php $_from = get_cat_arts_10(11); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_44396200_1443532512');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_44396200_1443532512']):
        $this->_foreach['artciles_list']['iteration']++;
?>
        <li class="clearfix"> <i class="<?php if ($this->_foreach['artciles_list']['iteration'] < 4): ?>i1<?php else: ?>i2<?php endif; ?>"> <?php echo $this->_foreach['artciles_list']['iteration']; ?></i> <span><a href="<?php echo $this->_var['article_0_44396200_1443532512']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['article_0_44396200_1443532512']['title']); ?>"><?php echo $this->_var['article_0_44396200_1443532512']['short_title']; ?></a></span> </li>
	  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	
...
?>
          <li class="Left clearfix">
            <div class="list Left">
              <div><a href="<?php echo $this->_var['releated_goods_data']['url']; ?>" target="_blank" title="<?php echo $this->_var['releated_goods_data']['goods_name']; ?>"> <img src="<?php echo $this->_var['releated_goods_data']['goods_thumb']; ?>" width="130" height="130" alt="<?php echo $this->_var['releated_goods_data']['goods_name']; ?>" /></a> </div>
...
?>
          <li class="<?php if ($this->_foreach['get_cat_new_goods_5']['iteration'] < 4): ?>first current<?php endif; ?> clearfix">
            ...
            <div class="hover"> <i class="<?php if ($this->_foreach['get_cat_new_goods_5']['iteration'] < 4): ?>i1<?php else: ?>i2<?php endif; ?>"><?php echo $this->_foreach['get_cat_new_goods_5']['iteration']; ?></i> <span><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><img src="<?php echo $this->_var['goods']['thumb']; ?>" width="88" height="88" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" /></a></span>
              <dl>
...
<body>
<?php echo $this->fetch('library/page_header.lbi'); ?>
<div class="art_banner"> <img src="themes/meilele/images/mll_article_banner.jpg" alt="筑就一个梦，眷恋一个家"> </div>
<div class="art_main w clearfix">
  <div class="art_nav clearfix Left">
    <div style="margin-left: -1px;"><img src="themes/meilele/images/article_830_logo.jpg" alt=""></div>
    <ul id="JS_silde_menu" class="art_nav_menu">
	<?php $_from = get_cat_arts_20(2); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_44396200_1443532512');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_44396200_1443532512']):
        $this->_foreach['artciles_list']['iteration']++;
?>
      <li class="art_box"> <a href="<?php echo $this->_var['article_0_44396200_1443532512']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['article_0_44396200_1443532512']['title']); ?>" name="JS_art_title" class="art_box_title <?php if ($this->_var['article_0_44396200_1443532512']['id'] == $this->_var['id']): ?>current<?php endif; ?>" id="JS_art_1"><?php echo htmlspecialchars($this->_var['article_0_44396200_1443532512']['title']); ?><span>COMPANY</span></a> </li>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
...
.art_nav  div dl dd a,.art_nav  div dl dd a:hover{display:block;height:20px;line-height:20px;padding-left:18px;background:url(themes/meilele/images/art_new20120417_1336631930.png);text-decoration:none;overflow:hidden;}
