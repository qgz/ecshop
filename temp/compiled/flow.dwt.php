...
?>
      <tr  id="tr_goods_<?php echo $this->_var['goods']['rec_id']; ?>">
        ...
        <td style="width:110px;"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img class="img" src="<?php echo $this->_var['goods']['goods_thumb']; ?>" width="58" height="58" title="查看商品" /></a> </td>
...
?><?php if ($this->_foreach['get_goods_ex']['iteration'] == 1): ?><?php echo $this->_var['goods_data']['goods_thumb']; ?><?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>" width="58" height="58" title="查看商品" /></a>
		<?php endif; ?>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</td>
...
?>
          ...
          <tr>
            ...
            <td style="padding-left:7px"><textarea name="post_script" rows="3" cols="70"></textarea>
            </td>
          </tr>
          <?php endif; ?>
        </table>
