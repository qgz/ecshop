...
<div id="" class="user_all w" style="position:relative;">
  <div id="" class="user_header clearfix" style="padding:15px 0px;">
    <div class="logo Left" style="background: url(themes/meilele/images/logo_user.png) 0 0 no-repeat;width:146px;height:53px"><a href="/" title="返回美乐乐首页"><img style="background:none" src="themes/meilele/images/blank.gif" width="146" height="53" border="0" alt="美乐乐"></a></div>
  </div>
  ...
  <div id="" class="user_content clearfix type_login">
    ...
    <div id="" class="user_login Right user_login_new">
	  ...
	  <tr>
            <td colspan="2" valign="middle"><table width="360" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td><a href="user.php?act=oath&type=qq"><img src="themes/meilele/images/qq_login.gif"/></a>
</td>
                                   <td><a href="user.php?act=oath&type=weibo"><img src="themes/meilele/images/sina_login_logo.gif"/></a>
</td>                  <td><a href="user.php?act=oath&type=alipay"><img src="themes/meilele/images/alipay_login.png"/></a>
</td><td><a href="user.php?act=oath&type=taobao"><img src="themes/meilele/images/taobao_login.gif"/></a>
</td>
                </tr>
              </tbody></table></td>
          </tr>
    ...
    <div id="" class="user_register Left" style="padding-top:20px;color:#555;width:436px;">
      ...
      <img src="themes/meilele/images/mp_user.gif" width="436" height="310" class="mt10" style="background:#fff" /> </div>
  </div>
  <?php endif; ?>
