...
?>
  ...
  <div id="JS_ship_link" class="w footer-link"><strong><a href="http://weimm.cn" target="_blank">合作网站</a>：</strong>
...
?>
  ...
  <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_56236500_1423042215');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_56236500_1423042215']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
  <a href="<?php echo $this->_var['nav_0_56236500_1423042215']['url']; ?>"  <?php if ($this->_var['nav_0_56236500_1423042215']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_56236500_1423042215']['name']; ?></a><?php if (! ($this->_foreach['nav_bottom_list']['iteration'] == $this->_foreach['nav_bottom_list']['total'])): ?> | <?php endif; ?>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  
  <br />
    <?php echo $this->_var['copyright']; ?> <script type="text/javascript">
